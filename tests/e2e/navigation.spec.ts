...
test.describe('Navigation', () => {
  ...
  test('doit naviguer vers la section "À propos" via le lien ancre', async ({ page }) => {
    await page.locator('header nav[aria-label="Navigation principale"] a', { hasText: 'À propos' }).click();
  ...
  test('doit naviguer vers le footer/contact via le lien ancre', async ({ page }) => {
    await page.locator('header nav[aria-label="Navigation principale"] a', { hasText: 'Contact' }).click();
  ...
  test('doit naviguer vers la page carte via le lien "La Carte"', async ({ page }) => {
    await page.locator('header nav[aria-label="Navigation principale"] a', { hasText: 'La Carte' }).click();
